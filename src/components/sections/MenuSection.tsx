      ...
      <div className="container mx-auto">
        ...
        <div className="relative h-[500px] w-full">
          ...
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-3 rounded-full z-10 hover:bg-white transition-colors"
          >
            <FaChevronLeft className="text-primary text-xl" />
          </button>
          <button
            onClick={handleNext}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-3 rounded-full z-10 hover:bg-white transition-colors"
          >
